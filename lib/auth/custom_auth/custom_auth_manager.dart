...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    timeHubV3RestoreAuthUserSubject.add(
      TimeHubV3RestoreAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<TimeHubV3RestoreAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  TimeHubV3RestoreAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = TimeHubV3RestoreAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    timeHubV3RestoreAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
TimeHubV3RestoreAuthUser? currentUser;
